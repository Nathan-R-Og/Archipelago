...
locations = {
    "Spectogram Module":                LocationInfo("In a drawer in the basement", "Alpha Base", region="Alpha Stairs"),
    ...
    **{f"TR{i+1} Gas Can {k+1}":        LocationInfo("", f"TR{i+1}", region="Outside" if i == 0 or i == 1 and k < 2 else f"TR{i+1} Room") for i, j in enumerate((5, 4, 1)) for k in range(j)},
    ...
    "TR1 Lighter":                      LocationInfo("", "TR1", region="TR1 Room"),
    "TR1 Broom":                        LocationInfo("", "TR1", region="TR1 Room"),
    "TR2 Car Battery Charger":          LocationInfo("", "TR2", region="TR2 Room"),
    ...
    **{f"Hole Gas Can {i+1}":           LocationInfo("", "The Hole") for i in range(2)},
    ...
    "Green Hatch Toolbox":              LocationInfo("", "Green Hatch", region="Green Hatch"),
    "Geiger Counter":                   LocationInfo("At the Green Hatch", "Green Hatch", region="Green Hatch"),
    "Green Hatch Welding Mask":         LocationInfo("", "Green Hatch", region="Green Hatch"),

    "Abandoned Shack Shovel":           LocationInfo("", "Abandoned Shack", region="Abandoned Shack"),
    "Axe":                              LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    "Deer Skull":                       LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    "Boar Trophy Head":                 LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    "Deer Trophy Head":                 LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    "Goat Trophy Head":                 LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    "Seed Pack (The Thingy)":           LocationInfo("In the Abandoned Shack", "Abandoned Shack", region="Abandoned Shack"),
    ...
    "Compost Bucket 1":                 LocationInfo("In the Village's farm plot", "Village", region="Restricted Area"),
    "Compost Bucket 2":                 LocationInfo("In the Village's farm plot", "Village", region="Restricted Area"),

    "Stonehenge Shovel":                LocationInfo("", "Stonehenge", region="Stonehenge"),
    ...
    "Unknown Fruit":                    LocationInfo("At -785.5/-821.7, out of fence", "Misc", rule=CanReachRegion("Garage") & Has("Gas Can")),  # Not strictly necessary but better with the ATV
    **{f"Forest Fuse {i+1}":            LocationInfo("At -331.9/-538.2", "Misc", enabled=fuse) for i in range(4)},
    ...
    "Furfur Altar Leg 2":               LocationInfo("Buried between rocks in Stonehenge at 252.9/585.1", "Stonehenge", enabled=buried, region="Stonehenge", rule=Has("Shovel")),
    ...
    "Oven Sandwich":                    LocationInfo("", "Alpha Base", enabled=chicken_sandwich, region="Staff Room"),
    "Basement Stairs Sandwich":         LocationInfo("", "Alpha Base", enabled=chicken_sandwich, region="Alpha Stairs", rule=Has("Crowbar")),
    "Garage Roof Sandwich":             LocationInfo("", "Alpha Base", enabled=chicken_sandwich, region="Alpha Roof"),
    "Ventilation Unit Sandwich":        LocationInfo("", "Alpha Base", enabled=chicken_sandwich, region="Alpha Roof"),
    "Radar Dome Sandwich":              LocationInfo("", "Alpha Base", enabled=chicken_sandwich, region="Alpha Roof", rule=Has("Half Hook")),
    ...
    "Stonehenge Sandwich":              LocationInfo("", "Stonehenge", enabled=chicken_sandwich, region="Stonehenge"),
    ...
    "Fenced Trees Sandwich":            LocationInfo("", "Misc", enabled=chicken_sandwich, region="New Trees Area"),
    ...
    "Bowtie 1":                         LocationInfo("In the New Trees area", "Misc", region="New Trees Area"),
    "Bowtie 2":                         LocationInfo("In the New Trees area", "Misc", region="New Trees Area"),
    "Glasses 1":                        LocationInfo("At the Green Hatch", "Green Hatch", region="Green Hatch"),
    "Glasses 2":                        LocationInfo("At the Green Hatch", "Green Hatch", region="Green Hatch"),
    ...
    **{f"TR{i+1} Limb Joints {j+1}":    LocationInfo("", f"TR{i+1}", enabled=goal({VOTVGoal.KERFUR_OMEGA}), region=f"TR{i+1} Room") for i in range(3) for j in range(2)},
    ...
    "Ritual Knife":                     LocationInfo("In the Lambert Ritual dimension, accessible in the Abandoned Shack at 3:33 AM", "Abandoned Shack", complex=True, enabled=goal({VOTVGoal.LAMBERT_PLUSH}, also=time_sensitive), region="Abandoned Shack"),
    ...
    "Alpha Roof Tile":                  LocationInfo("Above the living quarters", "Alpha Base", enabled=goal({VOTVGoal.GREEN_CABINET}), region="Alpha Roof"),
