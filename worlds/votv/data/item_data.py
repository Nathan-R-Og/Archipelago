...
extra_items = {
    ...
    "Scuba Gear":                               ExtraItem({IC.progression: 1}),
    ...
    "Physical Module (Automatic Polarity)":     ExtraItem({IC.useful: 1}),
    "Physical Module (Automatic Processing)":   ExtraItem({IC.useful: 1}),
    ...
    "Rubber Scrap Recipe":                      ExtraItem({IC.filler: 1}),
    "Paper Scrap Recipe":                       ExtraItem({IC.filler: 1}),
    ...
    "Progressive Radar History":                ExtraItem({IC.filler | EC.upgrade: 16}),
    "Progressive Detector Update Frequency":    ExtraItem({IC.filler | EC.upgrade: 16}),
    ...
    "Physical Module (Coordinate Triangle)":    ExtraItem({IC.filler: 1}),
    "Physical Module (Autosave Signal)":        ExtraItem({IC.filler: 1}),
    "Physical Module (Log Tapes Compression)":  ExtraItem({IC.filler: 1}),
    "Physical Module (Lightning Prediction)":   ExtraItem({IC.filler: 1}),
    "Physical Module (Spectogram)":             ExtraItem({IC.filler: 1}),
...
goal_items = {
    ...
    "Kerfur":                           GoalItem({VOTVGoal.KERFUR_OMEGA}, ExtraItem({IC.useful: 1, IC.filler: 1})),
