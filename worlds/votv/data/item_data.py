...
extra_items = {
    ...
    "Progressive Ping Strength":                        ExtraItem(upgrade({IC.useful: 8, IC.filler: 8})),
    ...
    "Physical Module (Radar Alarm)":                    ExtraItem(module({IC.useful: 1})),
    "Physical Module (Radar Radius)":                   ExtraItem(module({IC.useful: 1})),
